...
const api = 'http://localhost:8000/api/rutinaAm/'

const ShowRutinaAugmentar = () => {
  ...
  return (
    <div>
        ...
        <div className='container mt-3 border'>
            ...
            <Link to={`/augmentarpeso`} className='btn btn-primary m-1'>Volver</Link>
        </div>
    </div>
  )
}

export default ShowRutinaAugmentar